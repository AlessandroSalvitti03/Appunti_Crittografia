...
- **Gestione:** Se una risorsa è occupata, la transazione richiedente viene messa **in attesa** (spesso in una coda) finché la risorsa non si libera. Un contatore tiene traccia del numero di "lettori" simultanei.
			![[Pasted image 20260504154702.png]]
...
![[Pasted image 20260504154800.png]]
...
- Il viceversa non è sempre vero: esistono schedule che sono CSR ma che violano il protocollo 2PL (quindi l'insieme 2PL è un sottoinsieme del CSR). Ad esempio r1(x) w1(x) r2(x) w2(x) r3(y) w1(y). Dal punto di vista degli insiemi, la classe 2PL è contenuta nella classe CSR, che a sua volta è contenuta nella classe VSR.
